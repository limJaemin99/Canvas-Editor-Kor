...
export class Command {
  ...
  public executeIndentIncrease: CommandAdapt['indentIncrease']
  public executeIndentDecrease: CommandAdapt['indentDecrease']
  ...
  constructor(adapt: CommandAdapt) {
    ...
    this.executeIndentIncrease = adapt.indentIncrease.bind(adapt)
    this.executeIndentDecrease = adapt.indentDecrease.bind(adapt)
