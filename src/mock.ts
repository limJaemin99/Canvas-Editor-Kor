...
const text = `주소(主訴):\n발열 3일, 기침 5일.\n현병력:\n환자는 3일 전 명확한 유발 원인 없이 감기 후 안면 부종 발견, 발진 없음, 소변량 감소, 피로 출현, 외부 치료에서 호전 없어 본원 내원함.\n기왕력:\n당뇨병 10년, 고혈압 2년, 전염성 질환 1년. 기타 과거 질환 보고.\n유행병력:\n최근 14일 내 확진 환자, 의심 환자, 무증상 감염자 및 밀접 접촉자 접촉 부정; 최근 14일 내 다음 장소 방문 부정: 수산물·육류 도매시장, 농산물 시장, 재래시장, 대형 슈퍼마켓, 야시장; 최근 14일 내 이러한 장소 근무자와 밀접 접촉 부정; 최근 14일 내 주변(가정, 사무실 등)에서 2건 이상 집단 발병 부정; 최근 14일 내 발열 또는 호흡기 증상이 있는 사람 접촉 부정; 최근 14일 내 본인 발열 또는 호흡기 증상 부정; 최근 14일 내 격리 관찰 대상자 및 코로나19 관련 기타 상황 접촉 부정; 동반 가족 상기 상황 없음.\n신체 검사:\nT: 39.5℃, P: 80bpm, R: 20회/분, BP: 120/80mmHg;\n보조 검사:\n2020년 6월 10일, 혈액 검사: 적혈구 용적률 36.50%(낮음) 40~50; 단핵구 절대값 0.75*10/L(높음) 참고치: 0.1~0.6;\n외래 진단: 처치 치료: 전자 서명: 【】\n기타 기록:`
...
export const commentList: IComment[] = [
  {
    id: '1',
    content:
      '적혈구 용적률(HCT)은 단위 용적당 적혈구가 차지하는 전혈 용적의 비율을 나타내며, 적혈구와 혈장의 비율을 반영하는 데 사용됩니다.',
    userName: 'Hufe',
    rangeText: '적혈구 용적률',
...
export const options: IEditorOption = {
  ...
  pageNumber: {
    format: '제{pageNo}페이지/총{pageCount}페이지'
  },
  zone: {
    tipDisabled: false
  },
  maskMargin: [60, 0, 30, 0] // 메뉴바 높이60, 하단 툴바30은 마스크 레이어
}
